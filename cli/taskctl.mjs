...
async function execute(parsed, overrides) {
  ...
  if (!allowedOptions) {
    throw usageError(
      "Expected one of: project list/create/map, cloud login/status/logout, issue list/get/create/update/move/archive/restore/relation, comment list/add/update/delete, context current",
    );
  }
